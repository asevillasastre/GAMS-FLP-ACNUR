...
* se fija la anterior solucion como requisito para la siguiente fase
F_OBJ_1.up = F_OBJ_1.l;

* resolucion de la segunda fase
...
var_F_OBJ_2 = F_OBJ_2.l; var_bx_OOSJ(s,j,k) = bx_OOSJ.l(s,j,k); var_bx_OOGJ(g,j,k) = bx_OOGJ.l(g,j,k);
var_bx_ER(g,j,k) = bx_ER.l(g,j,k); var_bex_ER(g,j,k) = bex_ER.l(g,j,k);

* generacion del archivo de salida
Execute_unload "solucion_modelo_2" var_F_OBJ_1  var_I var_z var_x_OOSJ var_x_OOGJ var_x_ER var_ex_ER
var_y var_gamma_ var_C1 var_C2 var_F_OBJ_2 var_bz var_bx_OOSJ var_bx_OOGJ var_bx_ER var_bex_ER;
